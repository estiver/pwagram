...
workboxSW.router.registerRoute('https://pwagram-5a938.firebaseio.com/posts.json', function(args) {
...
workboxSW.precache([
  ...
  },
  {
    ...
    "revision": "36097b9ca31302e604309394765350e4"
  },
  {
    "url": "src/js/feed.min.js",
    "revision": "aeaeede06f6d1630630bbdd69106d05d"
  },
  {
      ...
      readAllData('sync-posts')
        .then(function(data) {
          for (var dt of data) {
            ...
            fetch('https://us-central1-pwagram-5a938.cloudfunctions.net/storePostData', {
              method: 'POST',
              body: postData
            })
              .then(function(res) {
